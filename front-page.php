...
?>
	...
	<main id="primary" class="site-main">
		...
		<section class="container pt-4 pb-5">
			<div id="carouselDark" class="carousel carousel-dark slide overflow-hidden rounded" data-bs-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/dog1.png" class="d-block w-100" alt="..."></a>
					
					</div>
					<div class="carousel-item" data-bs-interval="2000">
					<a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/dog2.png" class="d-block w-100" alt="..."></a>
		...
		<section class="container popular-products">
				...
				<p class="text-center">We offer a number of high quality toys to help kepp <br> your pets healthy and spoiled!</p>
			
				<div class="pt-5 pb-5">
					
					<?php echo do_shortcode( '[products popularity columns=4 rows=2 limit=8]' );?>
				</div>
		...
		<section class="categories pt-5 pb-5">
			<div class="container">
				...
				<div class="row pt-5">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							<img class="position-absolute top-0 bottom-0 end-0 start-0 img-fluid" src="<?php echo get_template_directory_uri();?>/img/categories/care.jpg" alt="" loading="lazy">
				...
				<div class="row mb-3">
					...
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							<img class="position-absolute top-0 bottom-0 end-0 start-0 img-fluid" src="<?php echo get_template_directory_uri();?>/img/categories/food.jpg" alt="" loading="lazy">
					...
					<div class="categories__col col-md-8 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							<div class="sale position-absolute top-0 bottom-0 end-0 start-0" style="z-index:1"></div>
							<img class="position-absolute top-0 bottom-0 end-0 start-0 img-fluid" src="<?php echo get_template_directory_uri();?>/img/categories/food.jpg" alt="" loading="lazy">
