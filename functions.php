...
function pawsgang_scripts() {
	...
	wp_enqueue_style( 'bootstrap-icons',  'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.0/font/bootstrap-icons.css');
...
function enqueue_custom_fonts(){
	if(!is_admin()){
		wp_register_style('source_sans_pro', 'https://fonts.googleapis.com/css2?family=Source+Sans+Pro:ital,wght@0,400;0,700;1,400;1,700&display=swap');
...
add_theme_support('woocommerce'); //Added by Oliver Leon | to support woocommerce


/* 
 * Remove WooCommerce Styles by Oliver Leon
 */ 
...
/* 
 * Enqueue your own WooCommerce StylesSheet by Oliver Leon
 */ 
